 ...
 * @author Rapunzel_PC
 */
@WebServlet(name = "UpdateTripNameDepartureServlet", urlPatterns = {"/update_tripname_departure.do"})
public class UpdateTripNameDepartureServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            this.log("設定行程名稱和出發日期發生錯誤",ex);
        } catch(DateTimeParseException ex){
            this.log("設定行程名稱和出發日期發生錯誤",ex);
        }catch(Exception ex){
            this.log("設定行程名稱和出發日期發生非預期錯誤",ex);
        }
